...
- **Protocollo** (`abstract`): This study examined whether replacing a modest portion of habitual endurance running with structured high-intensity interval training (HIIT) improves running economy, lactate-threshold velocity, and time-to-exhaustion in trained male distance runners.
- **Comparatore** (`abstract`): Twenty-eight trained male runners were randomized to HIIT (n = 14) or to a control group (n = 14) for 8 weeks.
- **Durata** (`abstract`): 8 week
- **Outcome** (`abstract`): This study examined whether replacing a modest portion of habitual endurance running with structured high-intensity interval training (HIIT) improves running economy, lactate-threshold velocity, and time-to-exhaustion in trained male distance runners.
- **Risultati** (`abstract`): HIIT produced greater improvements than control in running economy at 14 km/h (-3.8% vs -0.6%, p &lt; 0.001), velocity at 4 mmol·L-1 lactate (+4.2% vs +1.1%, p &lt; 0.001), time-to-exhaustion (+15.8% vs +2.8%, p &lt; 0.001), and 5-km time-trial time (-2.6% vs -0.6%, p = 0.002).
