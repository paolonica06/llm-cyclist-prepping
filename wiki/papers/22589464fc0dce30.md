# Figure 3: The impact of cycling performed before endurance training in the moderate (Δ
                      <sub>MI</sub>
                      ) versus heavy (Δ
                      <sub>HI</sub>
                      ) intensity domain on the plasma branched-chain amino acids (A) and plasma lactate concentration (B).

- **Autori**: n/d
- **Anno**: n/d · **Rivista**: n/d
- **DOI**: https://doi.org/10.7717/peerj.10491/fig-3 · **PMID**: n/d
