...
- Qualità: **moderate** · Confidenza: **high** · Trasferibilità ciclisti competitivi: **moderate**
  ...
  - _Ricerca in quattro banche dati e criteri di eleggibilità espliciti._
  - _Quindici studi permettono una mappatura relativamente ampia, ma non garantiscono una stima causale robusta._
  - _Una scoping review è orientata a descrivere l'estensione e l'eterogeneità della letteratura, non necessariamente a sintetizzare quantitativamente gli effetti._
  - _Dal testo non risulta una valutazione formale del rischio di bias o della certezza complessiva delle prove._
  - _Mescola discipline e livelli prestativi differenti, riducendo la specificità per ciclisti competitivi._
  - _L'eterogeneità dei protocolli prestativi limita confronti e prescrizioni precise._
...
- **Livello di allenamento** (`abstract`): Endurance athletes of different performance levels
...
- **Durata** (`abstract`): Long-term effects; specific duration not reported
- **Outcome** (`abstract`): Maximum or peak oxygen uptake; speed or power at aerobic and anaerobic thresholds; economy of movement; competition or time-trial performance
- **Risultati** (`abstract`): POL and PYR reported greater maximum oxygen uptake enhancements and improved speed or power associated with the aerobic threshold. All training-intensity-distribution models improved speed or power associated with the anaerobic threshold and competitive endurance performance. Testing protocols were heterogeneous, and further research is needed regarding economy of movement.
- **Effect size**: _non disponibile_
- **Limiti** (`abstract`): Further research is needed to establish effects on economy of movement, and performance testing protocols were quite heterogeneous.
