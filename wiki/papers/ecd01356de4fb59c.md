...
- **Partecipanti** (`abstract`): Purpose: Training intensity distribution is widely regarded as one of the main organizers of endurance training, yet its practical influence on aerobic capacity, lactate-threshold power, and fat oxidation in already well-trained cyclists remains incompletely resolved.
- **Livello di allenamento** (`abstract`): trained
- **Sesso** (`abstract`): male
- **Età**: _non disponibile_
- **Numerosità campione**: _non disponibile_
- **Protocollo** (`abstract`): Training was monitored using power meters, heart-rate records, and session-rated perceived-exertion data.
- **Comparatore**: _non disponibile_
- **Durata** (`abstract`): 10 week
- **Outcome** (`abstract`): Purpose: Training intensity distribution is widely regarded as one of the main organizers of endurance training, yet its practical influence on aerobic capacity, lactate-threshold power, and fat oxidation in already well-trained cyclists remains incompletely resolved.
- **Risultati** (`abstract`): Results: Significant group × time effects were observed for VO₂max (p = 0.031), peak aerobic power (p = 0.028), lactate-threshold power (p = 0.016), power at Fatmax (p = 0.009), peak fat oxidation (p = 0.004), and respiratory exchange ratio during submaximal exercise (p = 0.011).
