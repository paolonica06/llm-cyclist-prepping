...
- Qualità: **low** · Confidenza: **low** · Trasferibilità ciclisti competitivi: **high**
  ...
  - _Include direttamente 18 ciclisti allenati, ma soltanto nove per gruppo._
  - _La randomizzazione è dichiarata senza descrizione della sequenza, occultamento o analisi intention-to-treat._
  - _I gruppi mostrano differenze iniziali rilevanti per età, massa corporea e probabilmente composizione del campione._
  - _L'intervento di quattro settimane valuta soltanto adattamenti molto brevi._
  - _I volumi sono simili ma non identici; non sono fornite informazioni sufficienti su aderenza e carico effettivamente completato._
  - _Gli esiti principali sono peso e potenza di soglia funzionale; manca una prova di gara o time trial standardizzato._
  - _Sono riportati miglioramenti entro il gruppo polarizzato, ma dal testo non emerge un test convincente della differenza di cambiamento tra gruppi._
...
- **Protocollo** (`abstract`): Participants were randomly allocated to UMB (n=9) or POL (n=9) and trained for 4 weeks with similar total training time. POL completed 1024 min/week distributed as 88% in zone 1, 0% in zone 2, and 12% in zone 3. Body weight and functional threshold power were measured before and after training.
- **Comparatore** (`abstract`): UMB: 1085 min/week distributed as 70% in zone 1, 30% in zone 2, and 0% in zone 3
- **Durata** (`abstract`): 4 weeks
- **Outcome** (`abstract`): ['Body weight', 'Functional threshold power', 'Watts per kilogram']
- **Risultati** (`abstract`): Only the POL group reduced body weight and improved functional threshold power and watts per kilogram. Compared with threshold intensity distribution, four weeks of polarized training improved aerobic performance in trained cyclists.
