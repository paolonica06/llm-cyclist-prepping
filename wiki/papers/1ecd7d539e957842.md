...
- Qualità: **moderate** · Confidenza: **moderate** · Trasferibilità ciclisti competitivi: **moderate**
  ...
  - _Ricerca in tre banche dati, uso delle linee guida PRISMA e ampio corpus di 191 studi._
  - _Popolazioni, discipline, strumenti NIRS e protocolli molto eterogenei limitano la sintesi specifica per il ciclismo competitivo._
  - _L'abstract non riporta metanalisi, valutazione del rischio di bias o certezza dell'evidenza._
  - _Utile per principi di misurazione e monitoraggio, ma non dimostra direttamente benefici prestativi nei ciclisti competitivi._

## Dati estratti (fonte: abstract, metodo: llm)
- **Disegno dello studio** (`abstract`): Updated systematic review
- **Partecipanti** (`abstract`): Studies involving recreationally trained to elite athletes, with or without training programmes, who had physiological variables assessed using commercial oximeters or NIRS instrumentation; 3435 participants across 191 studies
- **Livello di allenamento** (`abstract`): Recreationally trained to elite athletes
- **Sesso**: _non disponibile_
- **Età**: _non disponibile_
- **Numerosità campione** (`abstract`): 3435
- **Protocollo** (`abstract`): Systematic search, appraisal and synthesis following Preferred Reporting Items for Systematic Reviews guidelines. Scopus, MEDLINE/PubMed and SPORTDiscus were searched from March 2017 to March 2023.
- **Comparatore**: _non disponibile_
- **Durata** (`abstract`): March 2017 to March 2023
- **Outcome** (`abstract`): Applications of muscle oximetry in assessing skeletal muscle oxidative performance during sports activities; applications to exercise and training; recent instrumental developments
- **Risultati** (`abstract`): 191 studies regrouping 3435 participants met the eligibility criteria, covering 37 domains of sport activities. NIRS information can be used as a meaningful marker of skeletal muscle oxidative capacity and as a monitoring tool alongside or in comparison with heart rate or mechanical power indices across exercise contexts, training types and interventions.
