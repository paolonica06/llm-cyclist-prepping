...
**Verifica metadati**: ✔ verificato
  ...
  - ⚠ Primo autore discordante: 'martin' vs 'gibala'
...
- **Protocollo** (`abstract`): Interval training refers to the basic concept of alternating periods of relatively intense exercise with periods of lower-intensity effort or complete rest for recovery.
- **Comparatore** (`abstract`): ≤10 min of intense exercise), compared with traditional moderate-intensity continuous training (MICT) protocols that are generally reflected in public health guidelines.
- **Durata**: _non disponibile_
- **Outcome** (`abstract`): In an effort to standardize terminology, a classification scheme was recently proposed in which the term 'high-intensity interval training' (HIIT) be used to describe protocols in which the training stimulus is 'near maximal' or the target intensity is between 80 and 100 % of maximal heart rate, and 'sprint interval training' (SIT) be used for protocols that involve 'all out' or 'supramaximal' eff
- **Risultati** (`abstract`): Interval training refers to the basic concept of alternating periods of relatively intense exercise with periods of lower-intensity effort or complete rest for recovery.
