...
- Tipo di studio: **Counterbalanced crossover study**
...
- **Disegno dello studio** (`abstract`): Counterbalanced crossover study
...
- **Protocollo** (`abstract`): 2 identical varied HIIT cycling sessions (6 × 5-min work intervals, 2.5-min active recovery) performed with and without intermittent vibration applied to the lower-intensity workloads of the work intervals; each 5-min work interval consisted of 3 blocks of 40 s at 100% maximal aerobic power interspersed with 60 s at a lower power output equal to lactate threshold plus 20% of the difference between lactate threshold and maximal aerobic power. Oxygen uptake and EMG activity of lower and upper limbs recorded during all 5-min work intervals.
- **Comparatore** (`abstract`): same session without vibration
- **Durata** (`abstract`): acute (single-session crossover comparison)
- **Outcome** (`abstract`): time spent ≥90% maximal oxygen uptake, electromyographic (EMG) activity of lower and upper limbs
- **Risultati** (`abstract`): Adding vibration induced a longer time ≥90% maximal oxygen uptake (11.14 [7.63] vs 8.82 [6.90] min, d = 0.64, P = .048) and increased EMG activity of lower and upper limbs during the lower-intensity workloads by 20% (16%) and 34% (43%) (d = 1.09 and 0.83; P = .03 and .015), respectively.
- **Effect size** (`abstract`): d = 0.64 (time ≥90% VO2max); d = 1.09 (EMG lower limbs); d = 0.83 (EMG upper limbs)
