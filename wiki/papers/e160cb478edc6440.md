...
- **Protocollo** (`abstract`): Effects of repeated high-intensity effort training or repeated sprint training on repeated high-intensity effort ability and in-game performance in professional rugby union players.
- **Comparatore** (`abstract`): J Strength Cond Res 38(5): 932–940, 2024—This study investigated the effects of repeated high-intensity efforts (RHIE) training compared with repeated sprint exercise (RSE) training on RHIE ability (RHIEa) and in-game performance in professional rugby union players.
- **Durata** (`abstract`): 10 week
- **Outcome** (`abstract`): Effects of repeated high-intensity effort training or repeated sprint training on repeated high-intensity effort ability and in-game performance in professional rugby union players.
- **Risultati** (`abstract`): The results of this study showed that concerning RHIEa, both the RHIE and RSE training significantly increased the players' average sprint velocity (p &lt; 0.001, d = −0.39 and p &lt; 0.001, d = −0.53 respectively), average sled push velocity (ASPV; p &lt; 0.001, d = −0.81 and p = 0.017, d = −0.48 respectively), and RHIE score (p &lt; 0.001, d = −0.72 and p &lt; 0.001, d = −0.60 respectively).
